...
\title{Implementation of an automated handover and services checks}
...
\diplomaName{National Applied Licence of Informatics}
\speciality{Informatic Systems and Softwares}
%\speciality{Génie des Télécommunications et Réseaux}
%\speciality{Génie Informatique des Systèmes Industriels}

%% Encadrant professionnel
\proFramerName{Mme Feyza BOUAZIZI}
\proFramerSpeciality{Engineer}

%% Encadrant académique
\academicFramerName{Mme Fatma HARMES}
\academicFramerSpeciality{Assistant}

%% Entreprise d'accueil
\companyName{Linedata Tunisie}

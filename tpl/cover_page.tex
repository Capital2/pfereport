...
\vspace{1.5mm}
\textbf{{El Manar's Higher Institute of Informatics}}
\end{minipage}
\hfill
...
\begin{center}
{\LARGE{\textbf{\textsc{End of Studies Report}}}}\\
\vskip0.5cm
\large

{\textbf{Presented for the obtention of}}\\
\vskip2mm
{\textbf{\@diplomaName}}\\
...
\begin{center}
\large
Realized within \@companyName\\
\vskip0.4cm
\begin{figure}[h]
\centering
{\color{isiBlue}{\fboxrule=2.5pt\fbox{\includegraphics[width=0.3\columnwidth]{Logo}}}}
\end{figure}
\end{center}
